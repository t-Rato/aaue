...
function Seccoes() {
    ...
    const selec = [
        {
            nome: "Secção 1",
            descricao: "Descrição da Secção 1",
            email: "seccao1@aaue.pt",
            membros: [
        ...
        {
            nome: "Secção 2",
            descricao: "Descrição da Secção 2",
            email: "seccao2@aaue.pt",
            membros: [
        ...
        {
            nome: "Secção 3",
            descricao: "Descrição da Secção 3",
            email: "seccao3@aaue.pt",
            membros: [
